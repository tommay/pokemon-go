...
showLog log =
  ...
  in Printf.printf "%.3f: %3d (%d/%d) %3d (%d/%d/%d) - %3d (%d/%d) %3d (%d/%d/%d): %s"
       ...
       (Attacker.fastDamage attacker)
       (Attacker.chargedDamage attacker)
       (Attacker.energy attacker)
       (Attacker.fastEnergy attacker)
       (Attacker.damageEnergy attacker)
       (Attacker.wastedEnergy attacker)
       (Defender.hp defender)
       (Defender.fastDamage defender)
       (Defender.chargedDamage defender)
       (Defender.energy defender)
       (Defender.fastEnergy defender)
