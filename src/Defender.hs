...
makeAMove this =
  let -- Get the next move and any move(s) after that.
      ...
      -- Energy from the move is available immediately to determine
      -- the next move.
      energy' = minimum [100, Defender.energy this + Move.energy move']
...
takeDamage pokemon move this =
  ...
  in this {
       ...
       energy = minimum [100,
         Defender.energy this + (fromIntegral damageDone) / 2]
       }
